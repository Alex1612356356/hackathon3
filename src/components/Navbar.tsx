    ...
    >
      <div className="glass px-8 py-3 rounded-full flex items-center gap-8">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-white/70">
          ...
          <a href="#" className="hover:text-white transition-colors">Cum funcționează</a>
          <a href="#" className="hover:text-white transition-colors">Analitice</a>
          <a href="#" className="hover:text-white transition-colors">Filozofie</a>
        </div>
